          ...
          <MacOSWindow title="About Me" variant="system">
            <div className="flex border-b mb-8 overflow-x-auto no-scrollbar">
              {[
                ...
                <button
                  key={key}
                  className={`py-3 px-6 font-medium transition ${activeTab === key ? "border-b-2 border-lime-200 text-lime-100" : "text-white/60 hover:text-white"}`}
              ...
              <div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="mb-4">{portfolio.summary}</p>
                    ...
                    <div className="space-y-4 mb-6">
                      {experiences.map((experience) => (
                        <div key={`${experience.company}-${experience.date}`} className="border-l-4 border-lime-200/70 pl-4">
                          ...
                          <p className="text-sm mb-1">{experience.company} | {experience.date}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
                      {skillGroups.slice(0, 4).map((group) => (
                        <div key={group.title} className="card p-3">
                          ...
                          <p className="text-sm">{group.items.slice(0, 5).join(", ")}</p>
                        </div>
                      ))}
                    </div>
